    ...
    <MemberLayout>
      ...
      <div className="mt-8 bg-slate-50 border border-slate-200 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-800">Ada Pertanyaan Seputar Paket Belajar?</h4>
            <p className="text-xs text-slate-500">Konsultasikan kebutuhan try out dan paket belajar Anda langsung dengan Admin.</p>
          </div>
        </div>
        <a
          href="https://wa.me/6285199655534?text=Halo%20Admin%20KlinikCPNS,%20saya%20ingin%20konsultasi%20seputar%20paket%20belajar"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-all shadow-sm shrink-0"
        >
          <span>WhatsApp Admin: +62 851-9965-5534</span>
